...
<img src="public/logo.svg" alt="炼丹蓝图 Logo" width="120" height="120" />
...
![Status](https://img.shields.io/badge/Status-Early_Access-orange)
...
<div align="center">
  <img src="display/全功能节点连线架构演示.png" alt="全功能节点连线架构演示" width="100%" />
  <br/><br/>
  <img src="display/节点右键功能展示图.png" alt="节点右键功能展示图" width="100%" />
</div>
...
>以下是设计的架构图
>整个项目是先设计的架构图，再根据架构图进行开发，所以架构图是前端开发过程中最重要的文档。
>此架构图的设计与调整耗费了我们大量的时间和脑力，希望开发者能够认真读完，相信能够快速理解整个项目的设计思路。

![前端架构图](display/前端架构图.jpg)
